Public Class QC_FrequenciesForm
    ...
    Private Sub QC_FrequenciesForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        With ProblemsDataTable
            ...
            .Columns.Add("SurveyType", GetType(String))
        ...
        Me.ProblemsDataGridView.DataSource = QCBindingSource
    ...
    Private Function GetProblemFrequencies(FrequencyTolerance As Double) As DataTable
        ...
        Sql = "SELECT  Herd,SightingDate,SurveyType, FrequenciesInGroup,GroupNumber,EID,FlightID FROM Dataset_Full WHERE (FrequenciesInGroup IS NOT NULL) AND (RTRIM(LTRIM(FrequenciesInGroup)) <> '')"
        ...
        For Each SurveyRow As DataRow In SurveysDataTable.Rows
            ...
            Dim SurveyType As String = SurveyRow.Item("SurveyType")
            ...
            For Each Frequency In FrequenciesList ' FrequenciesInGroup.Split(",")
                ...
                Dim DeploymentDataTable As DataTable = GetDeploymentDataTableFromFrequencyAndDate(Herd, Frequency, SightingDate, 0.001, False)
                ...
                ElseIf DeploymentDataTable.Rows.Count > 1 Then
                    ...
                    'More than one frequency found for the frequency and date
