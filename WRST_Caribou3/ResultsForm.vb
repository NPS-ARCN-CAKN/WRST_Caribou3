        ...
        Try
            ...
            If ViewName.Trim.Length > 0 Then
                Try
                    ...
                    'Set up group summaries
                    'Select Case Me.GroupSummaryTypeToolStripComboBox.Text
                    '    Case "Sum"
                    '        AddGroupSummaries(DevExpress.Data.SummaryItemType.Sum)
                    '    Case "Avg"
                    '        AddGroupSummaries(DevExpress.Data.SummaryItemType.Average)
                    '    Case "Min"
                    '        AddGroupSummaries(DevExpress.Data.SummaryItemType.Min)
                    '    Case "Max"
                    '        AddGroupSummaries(DevExpress.Data.SummaryItemType.Max)
                    '    Case "Count"
                    '        AddGroupSummaries(DevExpress.Data.SummaryItemType.Count)
                    'End Select
